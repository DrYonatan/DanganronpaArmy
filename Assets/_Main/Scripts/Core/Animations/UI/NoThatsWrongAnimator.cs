...
public class NoThatsWrongAnimator : MonoBehaviour
{
    ...
    public IEnumerator Show()
    {
        ...
        topBarRect.anchoredPosition = new Vector2(0, 125);
        topBarRect.localRotation = Quaternion.Euler(0, 0, -9);
        topBar.color = transparent;
        
        bottomBarRect.anchoredPosition = new Vector2(0, -250);
        ...
        topBarRect.DOAnchorPosY(550, appearDuration);
        topBarRect.DORotate(new Vector3(0f, 0f, -28f), appearDuration);
        topBar.DOFade(1f, appearDuration);
        
        bottomBarRect.DOAnchorPosY(-517, appearDuration);
        ...
        faceRect.anchoredPosition = new Vector2(810, -122);
        ...
        counterRect.anchoredPosition = new Vector2(1116, -290);
        ...
        counterRect.DOAnchorPos(new Vector2(-412, 251), 1.8f).SetEase(Ease.Linear);
        counterImage.rectTransform.anchoredPosition = new Vector2(0, -30);
        counterImage.rectTransform.DOAnchorPosY(30, 0.05f).SetLoops(-1, LoopType.Yoyo);
        ...
        counterRect.DOKill();
        counterRect.DOAnchorPos(new Vector2(-1865, 827), appearDuration).SetEase(Ease.Linear);
        face.DOFade(0f, appearDuration);

        yield return new WaitForSeconds(appearDuration);
        
        topBarRect.DOAnchorPosY(125, appearDuration);
        topBarRect.DORotate(new Vector3(0f, 0f, -9f), appearDuration);
        topBar.DOFade(0f, appearDuration);
        
        bottomBarRect.DOAnchorPosY(-250, appearDuration);
