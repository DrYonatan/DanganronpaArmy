...
public class CharacterCutIn : MonoBehaviour
{
    ...
    public Sprite firstBarsFrame;
    public Sprite secondBarsFrame;
    ...
    public void Animate()
    {
        ...
        sequence.Append(characterBody.DOAnchorPos(initialBodyPosition, 0.2f));
        sequence.Join(characterBody.DOScale(1f, 0.2f));
    ...
    private void SetInitialValues()
    {
        ...
        characterBody.localScale = new Vector3(0.5f, 1f, 1f);
    }
