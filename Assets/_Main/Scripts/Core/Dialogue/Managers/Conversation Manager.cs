...
namespace DIALOGUE
{
    public class ConversationManager
    {
        ...
        public void DecideCharactersToHide(string speakerName)
        {
            ...
            {
                if (GetCharacterPosition(character.name) == GetCharacterPosition(speakerName) && speakerName != character.name && speakerName != "Protagonist")
                    CharacterManager.instance.HideCharacter(character.name);
            }
